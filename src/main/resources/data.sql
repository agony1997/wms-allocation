...
-- 使用者不掛營業所欄位，營業所歸屬全部來自 auth_user_branch_role（角色）與 location（儲位）
INSERT INTO auth_user (user_code, email, user_name, password, phone, status, created_at, updated_at, created_by, updated_by) VALUES (N'A001', N'admin@example.com', N'管理員', N'$2a$10$aRi0uOtcUAdiokog5Fpq3OT0VmN.eNMhqFmeIMb.buX7uZMA7Whxa', N'0912345678', N'ACTIVE', N'2023-01-01 00:00:00', N'2023-01-01 00:00:00', N'SYSTEM', N'SYSTEM');
INSERT INTO auth_user (user_code, email, user_name, password, phone, status, created_at, updated_at, created_by, updated_by) VALUES (N'U001', N'user1@example.com', N'王小明', N'$2a$10$aRi0uOtcUAdiokog5Fpq3OT0VmN.eNMhqFmeIMb.buX7uZMA7Whxa', N'0923456789', N'ACTIVE', N'2023-01-01 00:00:00', N'2023-01-01 00:00:00', N'SYSTEM', N'SYSTEM');
INSERT INTO auth_user (user_code, email, user_name, password, phone, status, created_at, updated_at, created_by, updated_by) VALUES (N'U002', N'user2@example.com', N'李小華', N'$2a$10$aRi0uOtcUAdiokog5Fpq3OT0VmN.eNMhqFmeIMb.buX7uZMA7Whxa', N'0934567890', N'ACTIVE', N'2023-01-01 00:00:00', N'2023-01-01 00:00:00', N'SYSTEM', N'SYSTEM');
INSERT INTO auth_user (user_code, email, user_name, password, phone, status, created_at, updated_at, created_by, updated_by) VALUES (N'U003', N'user3@example.com', N'二狗子', N'$2a$10$aRi0uOtcUAdiokog5Fpq3OT0VmN.eNMhqFmeIMb.buX7uZMA7Whxa', N'0934567891', N'ACTIVE', N'2023-01-01 00:00:00', N'2023-01-01 00:00:00', N'SYSTEM', N'SYSTEM');
